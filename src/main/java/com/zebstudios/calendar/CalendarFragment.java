...
{
	public String TAG = "CALENDAR_FRAGMENT";
	 ...
	 */
	protected HashMap<String, Object> calendarData = new HashMap<String, Object>();
	 ...
	 */
	protected ArrayList<CalendarGridAdapter> datePagerAdapters = new ArrayList<CalendarGridAdapter>();
	...
	/**
	 * calendarListener inform library client of the event happens inside
	 * Calendar
	 */
	...
	/**
	 * calendarData return data belong to Calendar
	 *
	 * @return
	 */
	public HashMap<String, Object> getCalendarData()
	{
		...
		calendarData.put( START_DAY_OF_WEEK, Integer.valueOf( startDayOfWeek ) );
		calendarData.put( SIX_WEEKS_IN_CALENDAR, Boolean.valueOf( sixWeeksInCalendar ) );
	...
	public void restoreStatesFromKey( Bundle savedInstanceState, String key )
	{
		...
		{
			Bundle calendarSavedState = savedInstanceState.getBundle( key );
			setArguments( calendarSavedState );
		}
	}
	...
	public void restoreDialogStatesFromKey( FragmentManager manager, Bundle savedInstanceState, String key, String dialogTag )
	{
		...
		CalendarFragment existingDialog = (CalendarFragment) manager.findFragmentByTag( dialogTag );
	 ...
	 * background by changing CalendarFragment.selectedBackgroundDrawable, and
	 * change the text color CalendarFragment.selectedTextColor before call this
	...
	/**
	 * Set Calendar listener when user click on a date
	 *
	...
	public void refreshView()
	{
		...
		{
			// Reset Calendar data
			adapter.setCalendarData( getCalendarData() );
	...
	private void setupDateGridPages( View view )
	{
		...
		// Current month
		CalendarGridAdapter adapter0 = getNewDatesGridAdapter(
	...
	public class DatePageChangeListener implements ViewPager.OnPageChangeListener
	{
		...
		public void onPageSelected( int position )
		{
			...
			CalendarGridAdapter currentAdapter = calendarGridAdapters
