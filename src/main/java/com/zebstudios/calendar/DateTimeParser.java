...
/**
 * Convert a date-time from a string into a  {@link com.zebstudios.calendar.DateTime}.
 * The primary use case for this class is converting date-times from a database <tt>ResultSet</tt>
 * into a {@link com.zebstudios.calendar.DateTime}. It can also convert an ISO time, having a 'T' separating the date
 * from the time.
 */
