...
public class CirclePageIndicator extends View implements PageIndicator
{
	...
	public CirclePageIndicator( Context context, AttributeSet attrs, int defStyle )
	{
		...
		final int defaultPageColor = android.R.color.white;
		final int defaultFillColor = android.R.color.darker_gray;
		final int defaultOrientation = HORIZONTAL;
		final int defaultStrokeColor = R.color.main_color1;
		final float defaultStrokeWidth = 1;
		final float defaultRadius = 20;
		...
		mPaintPageFill.setStyle( Paint.Style.FILL_AND_STROKE );
