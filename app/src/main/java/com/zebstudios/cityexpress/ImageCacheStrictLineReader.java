...
public class ImageCacheStrictLineReader implements Closeable
{
	 ...
	 */
	public ImageCacheStrictLineReader( InputStream in, Charset charset )
	{
	 ...
	 */
	public ImageCacheStrictLineReader( InputStream in, int capacity, Charset charset )
	{
		...
		if( !( charset.equals( ImageCacheUtil.US_ASCII ) ) )
		{
