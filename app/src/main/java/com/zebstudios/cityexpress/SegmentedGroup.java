...
public class SegmentedGroup extends RadioGroup
{
	...
	public SegmentedGroup( Context context )
	{
		...
		mDisabledColor = resources.getColor( R.color.control_border_light );
		mDisabledTextColor = resources.getColor( R.color.control_border_dark );
	...
	private void updateBackground( View view, int checked, int unchecked )
	{
		...
		ColorStateList colorStateList = new ColorStateList( new int[][]{
				...
				{ android.R.attr.state_enabled, -android.R.attr.state_pressed, -android.R.attr.state_checked },
				{ android.R.attr.state_enabled, -android.R.attr.state_pressed, android.R.attr.state_checked },
				{ -android.R.attr.state_enabled, -android.R.attr.state_pressed, android.R.attr.state_checked },
				{ -android.R.attr.state_enabled, -android.R.attr.state_pressed, -android.R.attr.state_checked }},
				new int[]{ Color.BLUE, mTintColor, mCheckedTextColor, mDisabledTextColor, mDisabledTextColor  } );
		( (Button) view ).setTextColor( colorStateList );

		//Redraw with tint color
		Drawable checkedDrawable = resources.getDrawable( checked ).mutate();
		Drawable uncheckedDrawable = resources.getDrawable( unchecked ).mutate();
		Drawable disableDrawable = resources.getDrawable( unchecked ).mutate();

		( (GradientDrawable) checkedDrawable ).setColor( mTintColor );
		( (GradientDrawable) uncheckedDrawable ).setStroke( oneDP, mTintColor );
		( (GradientDrawable) disableDrawable ).setStroke( oneDP, mDisabledColor );

		//Create drawable
		StateListDrawable stateListDrawable = new StateListDrawable();
		stateListDrawable.addState( new int[]{ android.R.attr.state_enabled, -android.R.attr.state_checked }, uncheckedDrawable );
