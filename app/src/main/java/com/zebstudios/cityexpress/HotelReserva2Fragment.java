...
public class HotelReserva2Fragment extends Fragment implements PayPalCaller.PayPalCallerInterface
{
	...
	public void onActivityCreated( final Bundle savedInstanceState )
	{
		...
		Bundle args = ( (HotelDetailsActivity) getActivity() ).getReserva2FragmentArgs();

		if( args != null )
		{
			// Restore from backstack
			android.util.Log.d( "TEST", "Restore from backstack" );
		}
		else if( savedInstanceState != null )
		{
			// Restore from saved instance state
			android.util.Log.d( "TEST", "Restore from saved instance state" );
		}
		else
		{
			// Create from fragment arguments
			android.util.Log.d( "TEST", "Create from fragment arguments" );
			args = getArguments();
		}
	}
	...
	public View onCreateView( LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState )
	{
		...
		_view = inflater.inflate( R.layout.fragment_hotel_reserva2, container, false );
		...
		lblBack.setOnClickListener( new View.OnClickListener()
		{
			...
			public void onClick( View v )
			{
				...
				getFragmentManager().beginTransaction().remove( HotelReserva2Fragment.this ).commit();
			}
		} );
		...
		TextView lblHotelName2 = (TextView) _view.findViewById( R.id.lblHotelName2 );
		TextView lblArrivalDate2 = (TextView) _view.findViewById( R.id.dates_arrival_text2 );
		TextView lblDepartureDate2 = (TextView) _view.findViewById( R.id.dates_departure_text2 );
		...
		lblArrivalDate2.setText( sdf.format( _arrivalDate ) );
		lblDepartureDate2.setText( sdf.format( _departureDate ) );
		...
		NestedListView list2 = (NestedListView) _view.findViewById( R.id.list_summary2 );
		...
		{
			android.util.Log.d( "TEST", "TIME: LESS THAN 48 HOURS" );
		}
		else
		{
			android.util.Log.d( "TEST", "TIME: OK" );
		}
		...
		_view.setOnKeyListener( new View.OnKeyListener()
		{
			...
			public boolean onKey( View v, int keyCode, KeyEvent event )
			{
				...
				{
					if( _isShowingWebView )
					{
						android.util.Log.d( "TEST", "WEBVIEW Back Pressed" );
					...
					{
						android.util.Log.d( "TEST", "Back Pressed NO WEBVIEW" );
						return false;
					}
				}
				return false;
	...
	private boolean validateCapture()
	{
		...
		if( _paymentMethod == PAYMENT_METHOD_CARD )
		{
			if( isLessThan48hoursToArrival() )
			{
				alert( "Tu reservación con Tarjeta de Crédito no puede ser realizada con menos de 48 horas de anticipación." );
				return false;
			}
