...
public class HotelDetailsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (_hotel.getIdMarca() == 1) setTheme(R.style.MainTheme);
        else if (_hotel.getIdMarca() == 4) setTheme(R.style.PlusTheme);
        else if (_hotel.getIdMarca() == 3) setTheme(R.style.SuitesTheme);
        else if (_hotel.getIdMarca() == 2) setTheme(R.style.JuniorTheme);
