...
public final class DateTime implements Comparable<DateTime>, Serializable
{
	 ...
	 * <P>See {@link #getWeekIndex(com.zebstudios.calendar.DateTime)} as well, which takes an arbitrary date to define
	 * day 1 of week 1.
	 * <P>Requires year-month-day to be present; if not, a runtime exception is thrown.
	 */
	 ...
	 * Return <tt>true</tt> only if this <tt>DateTime</tt> comes before the given parameter, according to {@link #compareTo(com.zebstudios.calendar.DateTime)}.
	 */
	 ...
	 * Return <tt>true</tt> only if this <tt>DateTime</tt> comes after the given parameter, according to {@link #compareTo(com.zebstudios.calendar.DateTime)}.
	 */
	 ...
	 *
	 * @param aPrecision takes any value <i>except</i> {@link com.zebstudios.calendar.DateTime.Unit#NANOSECONDS} (since it makes no sense to truncate to the highest
	 *                   available precision).
	 */
	 ...
	 * (and only then) the given {@link com.zebstudios.calendar.DateTime.DayOverflow} policy applied, and the day-of-the-month is adusted accordingly.
	 * <p/>
	 ...
	 * <P>This method has nearly the same behavior as {@link #plus(Integer, Integer, Integer, Integer, Integer, Integer, Integer, com.zebstudios.calendar.DateTime.DayOverflow)},
